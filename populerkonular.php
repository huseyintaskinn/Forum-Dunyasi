...
<head>
	...
	<title>Forum Dünyası | Popüler Konular</title>
		...
		<div id="forumlar">
			<div class="konu">
				<?php
					  ...
					  echo "<div style='display: flex;'><a class='konuadi' href='populerkonular.php'>Popüler Konular</a></div>";
					  ...
					  $konular=populersirala($konular);
					  //Yorum sayısı + (görüntülenme sayısı / 100) toplamına göre sıralanıyor.
					
				?>

				<p class="baslik">En Çok Görüntülenen ve En Çok Yorum Alan Konular</p>
				<div class="ilksatir">
